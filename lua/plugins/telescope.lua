...
return {
  ...
  keys = {
    ...
    { '<leader>sd', function() require('telescope.builtin').diagnostics(ivy()) end, desc = '[S]earch [D]iagnostics' },
    { '<leader><leader>', function() require('telescope.builtin').buffers() end, desc = '[ ] Find existing buffers' },
    { '<leader>/', function() require('telescope.builtin').current_buffer_fuzzy_find(ivy()) end, desc = '[/] Fuzzily search in current buffer' },
    ...
    { '<leader>fB', function() require('telescope').extensions.file_browser.file_browser { path = vim.fn.expand '%:p:h', select_buffer = true } end, desc = 'File browser (current dir)' },
    ...
    { '<leader>fh', function() require('telescope.builtin').command_history() end, desc = 'Command History' },
    ...
    -- Search operations
    { '<leader>sa', function() require('telescope.builtin').autocommands() end, desc = '[S]earch [A]utocommands' },
    { '<leader>sb', function() require('telescope.builtin').current_buffer_fuzzy_find() end, desc = '[S]earch in current [B]uffer' },
    { '<leader>sc', function() require('telescope.builtin').commands() end, desc = '[S]earch [C]ommands' },
    { '<leader>sC', function() require('telescope.builtin').command_history() end, desc = '[S]earch [C]ommand history' },
    { '<leader>se', function() require('telescope').extensions.symbols.symbols() end, desc = '[S]earch symbols' },
    { '<leader>sj', function() require('telescope.builtin').jumplist() end, desc = '[S]earch [J]umplist' },
    { '<leader>sl', function() require('telescope.builtin').loclist() end, desc = '[S]earch [L]ocation list' },
    { '<leader>sm', function() require('telescope.builtin').keymaps() end, desc = '[S]earch key[M]aps' },
    ...
    { '<leader>st', function() require('telescope').extensions.live_grep_args.live_grep_args() end, desc = '[S]earch [T]ext with args' },
    { '<leader>sT', function() require('telescope.builtin').treesitter() end, desc = '[S]earch [T]reesitter symbols' },
    { '<leader>sy', function() require('telescope.builtin').filetypes() end, desc = '[S]earch file t[Y]pes' },

    -- Git operations
    { '<leader>sGb', function() require('telescope.builtin').git_branches() end, desc = '[S]earch [G]it [B]ranches' },
    { '<leader>sGc', function() require('telescope.builtin').git_commits() end, desc = '[S]earch [G]it [C]ommits' },
    ...
    -- Project management
    { '<leader>pp', function() require('telescope').extensions.project.project() end, desc = 'Switch [P]roject' },
    { '<leader>pr', function() require('telescope.builtin').oldfiles { cwd_only = true } end, desc = '[P]roject [R]ecent files' },
    { '<leader>pf', function() require('telescope.builtin').find_files { cwd_only = true } end, desc = '[P]roject [F]iles' },
    { '<leader>pg', function() require('telescope.builtin').live_grep { cwd_only = true } end, desc = '[P]roject [G]rep' },

    -- Undo
    { '<leader>u', function() require('telescope').extensions.undo.undo() end, desc = 'Undo history' },
  },
  -- stylua: ignore end
  dependencies = {
